...
This is a sample template for HelloNode - Below is a brief explanation of what we have generated for you:
...
|  OutputValue|  https://bib4rd9azl.execute-api.us-east-1.amazonaws.com/Prod/hello/   |
+-------------+-----------------------------------------------------------------------+
...
```bash
sam logs -n HelloWorldFunction --stack-name hellonode --tail
```
...
```bash
aws cloudformation delete-stack --stack-name hellonode
```
...
# More examples - https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/serverless-getting-started-hello-world.html
